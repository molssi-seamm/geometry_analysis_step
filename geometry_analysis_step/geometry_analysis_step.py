...
class GeometryAnalysisStep(object):
    ...
    comments. The fields are as follows:
        ...
        my_description["description"] : tuple
            A description of the Geometry Analysis step. It must be
    ...
    def create_node(self, flowchart=None, **kwargs):
        ...
        **kwargs : keyword arguments
        ...
        return geometry_analysis_step.GeometryAnalysis(flowchart=flowchart, **kwargs)
    ...
    def create_tk_node(self, canvas=None, **kwargs):
        ...
        **kwargs : keyword arguments
        ...
        return geometry_analysis_step.TkGeometryAnalysis(canvas=canvas, **kwargs)
    ...
    def description(self):
        ...
        """
        return GeometryAnalysisStep.my_description
