...
setup(
    ...
    url='https://github.com/molssi-seamm/geometry_analysis_step',
    ...
    packages=find_packages(include=['geometry_analysis_step']),
    ...
    entry_points={
        'org.molssi.seamm': [
            'Geometry Analysis = geometry_analysis_step:GeometryAnalysisStep',
        ],
        'org.molssi.seamm.tk': [
            'Geometry Analysis = geometry_analysis_step:GeometryAnalysisStep',
        ],
